...
#ifndef EDGE_DEVICE_RTEMS_H
#define EDGE_DEVICE_RTEMS_H
...
class device_rtems : public shim<device_edge>
{
public:
  device_rtems(handle_type device_handle, id_type device_id, bool user);
