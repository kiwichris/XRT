...
#ifndef EDGE_SYSTEM_RTEMS_H
#define EDGE_SYSTEM_RTEMS_H

#include "core/edge/common/system_edge.h"

namespace xrt_core {

class system_rtems : public system_edge
{
public:
  void
  ...
  std::shared_ptr<device>
  get_userpf_device(device::handle_type handle, device::id_type) const;
